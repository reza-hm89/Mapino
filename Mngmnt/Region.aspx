<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Region.aspx.cs" Inherits="Mngmnt_Region" %>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">ایجاد استان/شهر</li>
                <li class="search-box">
            ...
            <div class=" panel-body">
                ...
                <div class=" form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class=" col-sm-9">
                            <input type="text" placeholder="موقعیت" class="form-control" id="txtPosition" name="">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div id="DivSave" class="col-sm-4 col-sm-offset-2">
                            <button id="btnSaveRegion" class="btn btn-blue next-step btn-block">
                                ثبت اطلاعات
                            </button>
                        </div>
                    </div>
