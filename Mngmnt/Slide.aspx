            ...
            <div class=" panel-body">
                ...
                <div class=" form-horizontal">
                     <div class="form-group">
                        ...
                        <div class=" col-sm-9">
                            <input type="text" placeholder="عنوان 1" class="form-control" id="txtTitle1">
                        </div>
                    </div>
                       <div class="form-group">
                        <label class="col-sm-2 control-label">
                        ...
                        <div class=" col-sm-9">
                            <input type="text" placeholder="عنوان 2" class="form-control" id="txtTitle2">
                        </div>
                    </div>
                       <div class="form-group">
                        <label class="col-sm-2 control-label">
                        ...
                        <div class=" col-sm-9">
                            <input type="text" placeholder="عنوان 3" class="form-control" id="txtTitle3">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">
                    ...
                    <div class="form-group">
                        ...
                        <div class=" col-sm-9">
                            <input type="number" placeholder="مدت زمان نمایش" class="form-control InputRequire" id="txtShowTime" name="email">
                        </div>
