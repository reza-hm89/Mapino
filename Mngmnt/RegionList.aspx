<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegionList.aspx.cs" Inherits="Mngmnt_RegionList" %>
...
<head>
    ...
    <script src="js/RegionList.js"></script>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">لیست استان/شهر</li>
