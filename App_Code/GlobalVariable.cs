...
public class GlobalFunction
{
    ...
    public static bool SendEmail(string email, string title, string description)
    {
        try
        {
            ...
            SmtpServer.Credentials = new System.Net.NetworkCredential("info@mapino.ir", "Mappi_Reza@.ir123");
            SmtpServer.Host = "mail.mapino.ir";
            SmtpServer.Port = 25;
            ...
            maill.From = new MailAddress("info@mapino.ir", "وب سایت مپی نو - سامانه مشاغل", System.Text.Encoding.UTF8);
            Byte i;
